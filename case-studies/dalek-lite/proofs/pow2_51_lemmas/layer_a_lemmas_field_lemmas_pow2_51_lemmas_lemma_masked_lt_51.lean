...
namespace layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51

-- vrml:begin layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51.call_requires_1 27bfca776b8aac27
/--
Generated VC `layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51.call_requires_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:109:5-109:31`
- Rust/SST construct: call lemma_u64_masked_lt
- AssertId: `1`
- Statement hash: `27bfca776b8aac27`
-/
def call_requires_1_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 31
  assertId := "1"
  functionName := "layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51"
  kind := "call_requires"
  statementHash := "27bfca776b8aac27"
}
...
-- vrml:end layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51.call_requires_1

-- vrml:begin layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51.ensures_2 94a7a273a250fc7f
/--
Generated VC `layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51.ensures_2`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/pow2_51_lemmas.rs:106:9-106:34`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `2`
- Statement hash: `94a7a273a250fc7f`
-/
def ensures_2_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51"
  kind := "ensures"
  statementHash := "94a7a273a250fc7f"
}
@[vrml_obligation] theorem ensures_2
    ...
    (call_l51_bit_mask_lt_ensures_0 : layer_a.specs.field_specs_u64.mask51 = vstd.bits.low_bits_mask 51)
    (call_l51_bit_mask_lt_ensures_1 : layer_a.specs.field_specs_u64.mask51 < Vermilion.Bits.shl 64 1 51)
    (call_lemma_u64_masked_lt_ensures_0 : Vermilion.Bits.band 64 v ((vstd.bits.low_bits_mask 51) % 18446744073709551616) < Vermilion.Bits.shl 64 (1 % 18446744073709551616) 51) :
    Vermilion.Bits.band 64 v layer_a.specs.field_specs_u64.mask51 < Vermilion.Bits.shl 64 1 51 := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51.ensures_2

end layer_a.lemmas.field_lemmas.pow2_51_lemmas.lemma_masked_lt_51
