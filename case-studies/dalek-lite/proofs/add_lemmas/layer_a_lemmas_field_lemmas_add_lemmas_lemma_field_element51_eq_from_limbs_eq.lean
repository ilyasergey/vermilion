...
namespace layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq

-- vrml:begin layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.assert_0 5c5969bde2471e13
/--
Generated VC `layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.assert_0`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:60:12-60:31`
- Rust/SST construct: Rust source assertion
- AssertId: `0`
- Statement hash: `5c5969bde2471e13`
...
def assert_0_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 31
  assertId := "0"
  functionName := "layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq"
  kind := "assert"
  statementHash := "5c5969bde2471e13"
}
...
/--
Generated VC `layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.assert_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:61:12-61:18`
- Rust/SST construct: Rust source assertion
- AssertId: `1`
- Statement hash: `1ef6badad4848b95`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs a) vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs b) vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs a) i⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs b) i⟩
-/
def assert_1_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq"
  kind := "assert"
  statementHash := "1ef6badad4848b95"
}
...
/--
Generated VC `layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.ensures_2`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/add_lemmas.rs:57:9-57:15`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `2`
- Statement hash: `cfa95b45a600bb4e`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs a) vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs b) vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs a) i⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs b) i⟩
-/
def ensures_2_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq"
  kind := "ensures"
  statementHash := "cfa95b45a600bb4e"
}
...
-- vrml:end layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq.ensures_2

end layer_a.lemmas.field_lemmas.add_lemmas.lemma_field_element51_eq_from_limbs_eq
