...
namespace layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128.assert_3 97df24b0192f46b8
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128.assert_3`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:45:1-45:48`
- Rust/SST construct: Rust source assertion
- AssertId: `3`
- Statement hash: `97df24b0192f46b8`
-/
def assert_3_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 48
  assertId := "3"
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128"
  kind := "assert"
  statementHash := "97df24b0192f46b8"
}
@[vrml_obligation] theorem assert_3
  ...
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128.assert_3

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128.assert_4 08e7922239d83cd3
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128.assert_4`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:45:1-45:48`
- Rust/SST construct: assertion failed
- AssertId: `4`
- Statement hash: `08e7922239d83cd3`
-/
def assert_4_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128"
  kind := "assert"
  statementHash := "08e7922239d83cd3"
}
...
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128.assert_4

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128.ensures_5 ed054839141423e5
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128.ensures_5`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:45:1-45:48`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `5`
- Statement hash: `ed054839141423e5`
-/
def ensures_5_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128"
  kind := "ensures"
  statementHash := "ed054839141423e5"
}
@[vrml_obligation] theorem ensures_5
    ...
    (then_0_assert_4 : (128 = 128) → (x < 340282366920938463463374607431768211456))
    (then_0_assume_70 : (128 = 128) → (x < Vermilion.natClip (18446744073709551616 * 18446744073709551616))) :
    x < vstd.arithmetic.power2.pow2 128 := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128.ensures_5

end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_u128_lt_pow2_128
