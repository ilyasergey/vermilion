...
namespace layer_a.lemmas.common_lemmas.shift_lemmas.lemma_u128_shl_is_mul

-- vrml:begin layer_a.lemmas.common_lemmas.shift_lemmas.lemma_u128_shl_is_mul.ensures_0 99e5230325721c87
/--
Generated VC `layer_a.lemmas.common_lemmas.shift_lemmas.lemma_u128_shl_is_mul.ensures_0`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/shift_lemmas.rs:53:9-53:58`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `0`
- Statement hash: `99e5230325721c87`
-/
def ensures_0_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 58
  assertId := "0"
  functionName := "layer_a.lemmas.common_lemmas.shift_lemmas.lemma_u128_shl_is_mul"
  kind := "ensures"
  statementHash := "99e5230325721c87"
}
@[vrml_obligation] theorem ensures_0
    (x : Int)
    (shift : Int)
    (requires_0 : Vermilion.inUnsignedRange 128 x)
    (requires_1 : Vermilion.inUnsignedRange 128 shift)
    (requires_2 : (0 ≤ shift) ∧ (shift < 128))
    (requires_3 : (x * vstd.arithmetic.power2.pow2 shift) ≤ 340282366920938463463374607431768211455)
    (assume_4 : False) :
    Vermilion.Bits.shl 128 x shift = (x * vstd.arithmetic.power2.pow2 shift) := by
...
-- vrml:end layer_a.lemmas.common_lemmas.shift_lemmas.lemma_u128_shl_is_mul.ensures_0

end layer_a.lemmas.common_lemmas.shift_lemmas.lemma_u128_shl_is_mul
