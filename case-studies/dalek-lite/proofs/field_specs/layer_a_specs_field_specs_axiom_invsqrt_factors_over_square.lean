...
namespace layer_a.specs.field_specs.axiom_invsqrt_factors_over_square

-- vrml:begin layer_a.specs.field_specs.axiom_invsqrt_factors_over_square.ensures_0 f335d57f3a5b5c22
/--
Generated VC `layer_a.specs.field_specs.axiom_invsqrt_factors_over_square.ensures_0`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/specs/field_specs.rs:645:9-647:10`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `0`
- Statement hash: `f335d57f3a5b5c22`
-/
def ensures_0_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 10
  assertId := "0"
  functionName := "layer_a.specs.field_specs.axiom_invsqrt_factors_over_square"
  kind := "ensures"
  statementHash := "f335d57f3a5b5c22"
}
@[vrml_obligation] theorem ensures_0
    ...
    (requires_0 : 0 ≤ a)
    (requires_1 : 0 ≤ b)
    (requires_2 : (¬ ((Vermilion.emod a (layer_a.specs.field_specs_u64.p 0)) = 0)))
    (requires_3 : (¬ ((Vermilion.emod b (layer_a.specs.field_specs_u64.p 0)) = 0)))
    (assume_4 : False) :
    layer_a.specs.field_specs.nat_invsqrt (layer_a.specs.field_specs.field_mul a (layer_a.specs.field_specs.field_square b)) = layer_a.specs.field_specs.field_abs (layer_a.specs.field_specs.field_mul (layer_a.specs.field_specs.nat_invsqrt a) (layer_a.specs.field_specs.field_inv b)) := by
...
-- vrml:end layer_a.specs.field_specs.axiom_invsqrt_factors_over_square.ensures_0

end layer_a.specs.field_specs.axiom_invsqrt_factors_over_square
