...
namespace layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.call_requires_1 a45c00f44984a10f
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.call_requires_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:163:9-163:78`
- Rust/SST construct: call lemma_mod_is_mod_recursive
- AssertId: `1`
- Statement hash: `a45c00f44984a10f`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩
-/
def call_requires_1_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 78
  assertId := "1"
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "call_requires"
  statementHash := "a45c00f44984a10f"
}
@[vrml_obligation] theorem call_requires_1
    ...
    (requires_4 : layer_a.specs.core_specs.u8_32_as_nat bytes = (Vermilion.emod (layer_a.specs.field_specs_u64.u64_5_as_nat (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe)) (layer_a.specs.field_specs_u64.p 0)))
    (assume_5 : True)
    (call_pow255_gt_19_ensures_0 : vstd.arithmetic.power2.pow2 255 > 19) :
    layer_a.specs.field_specs_u64.p 0 > 0 := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.call_requires_1

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_2 88aaa49127d7e79b
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_2`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:161:12-161:37`
- Rust/SST construct: Rust source assertion
- AssertId: `2`
- Statement hash: `88aaa49127d7e79b`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩
-/
def assert_2_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "assert"
  statementHash := "88aaa49127d7e79b"
}
@[vrml_obligation] theorem assert_2
    ...
    (assume_5 : True)
    (call_pow255_gt_19_ensures_0 : vstd.arithmetic.power2.pow2 255 > 19)
    (call_lemma_mod_is_mod_recursive_ensures_0 : vstd.arithmetic.internals.mod_internals.mod_recursive (layer_a.specs.field_specs_u64.u64_5_as_nat (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe)) (layer_a.specs.field_specs_u64.p 0) = (Vermilion.emod (layer_a.specs.field_specs_u64.u64_5_as_nat (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe)) (layer_a.specs.field_specs_u64.p 0))) :
    layer_a.specs.core_specs.u8_32_as_nat bytes < layer_a.specs.field_specs_u64.p 0 := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_2

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.call_requires_3 a700b35a9778fb17
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.call_requires_3`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:167:5-167:54`
- Rust/SST construct: call lemma_spec_fe51_to_bytes_matches_array
- AssertId: `3`
- Statement hash: `a700b35a9778fb17`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩
-/
def call_requires_3_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "call_requires"
  statementHash := "a700b35a9778fb17"
}
@[vrml_obligation] theorem call_requires_3
    ...
    (requires_3 : (∀ (vrml_i0 : Int), (((0 ≤ vrml_i0) ∧ (vrml_i0 < Vermilion.Seq.len bytes)) → Vermilion.inUnsignedRange 8 (Vermilion.Seq.index bytes vrml_i0))))
    (requires_4 : layer_a.specs.core_specs.u8_32_as_nat bytes = (Vermilion.emod (layer_a.specs.field_specs_u64.u64_5_as_nat (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe)) (layer_a.specs.field_specs_u64.p 0)))
    (assume_5 : True → (layer_a.specs.core_specs.u8_32_as_nat bytes < layer_a.specs.field_specs_u64.p 0)) :
    layer_a.specs.core_specs.u8_32_as_nat bytes = (Vermilion.emod (layer_a.specs.field_specs_u64.u64_5_as_nat (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe)) (layer_a.specs.field_specs_u64.p 0)) := by
...
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.call_requires_3

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_4 c23c39a5a54b5980
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_4`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:170:12-170:46`
- Rust/SST construct: Rust source assertion
- AssertId: `4`
- Statement hash: `c23c39a5a54b5980`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i⟩ ⟨Vermilion.Seq.index bytes i⟩
-/
def assert_4_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "assert"
  statementHash := "c23c39a5a54b5980"
}
@[vrml_obligation] theorem assert_4
    ...
    (requires_4 : layer_a.specs.core_specs.u8_32_as_nat bytes = (Vermilion.emod (layer_a.specs.field_specs_u64.u64_5_as_nat (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe)) (layer_a.specs.field_specs_u64.p 0)))
    (assume_5 : True → (layer_a.specs.core_specs.u8_32_as_nat bytes < layer_a.specs.field_specs_u64.p 0))
    (call_lemma_spec_fe51_to_bytes_matches_array_ensures_0 : (∀ (i : Int), (((0 ≤ i) ∧ (i < 32)) → (Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i = Vermilion.Seq.index bytes i)))) :
    Vermilion.Seq.len (layer_a.specs.field_specs.spec_fe51_as_bytes fe) = 32 := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_4

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_5 5439738b844825a4
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_5`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:171:12-171:41`
- Rust/SST construct: Rust source assertion
- AssertId: `5`
- Statement hash: `5439738b844825a4`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i⟩ ⟨Vermilion.Seq.index bytes i⟩
-/
def assert_5_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "assert"
  statementHash := "5439738b844825a4"
}
@[vrml_obligation] theorem assert_5
    ...
    (assume_5 : True → (layer_a.specs.core_specs.u8_32_as_nat bytes < layer_a.specs.field_specs_u64.p 0))
    (call_lemma_spec_fe51_to_bytes_matches_array_ensures_0 : (∀ (i : Int), (((0 ≤ i) ∧ (i < 32)) → (Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i = Vermilion.Seq.index bytes i))))
    (assert_4 : Vermilion.Seq.len (layer_a.specs.field_specs.spec_fe51_as_bytes fe) = 32) :
    Vermilion.Seq.len (layer_a.core_assumes.seq_from32 bytes) = 32 := by
  iterate 13 (try first | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.factorial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.shifted_binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.product_of_multiples]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u8]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u16]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u32]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u64]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.sum_lemmas.seq_sum]; try norm_num))
  vrml [layer_a.specs.field_specs.sum_of_limbs_bounded, layer_a.backend.serial.u64.field.impl__5.add_req, vstd.arithmetic.power2.pow2, layer_a.specs.field_specs_u64.u64_5_as_nat, layer_a.specs.field_specs.spec_add_fe51_limbs, layer_a.specs.field_specs_u64.p, layer_a.specs.field_specs_u64.field_canonical, layer_a.specs.field_specs_u64.u64_5_as_field_canonical, layer_a.specs.field_specs.fe51_as_canonical_nat, layer_a.specs.field_specs.field_add, layer_a.backend.serial.u64.field.impl__5.obeys_add_spec, layer_a.backend.serial.u64.field.impl__5.add_spec, layer_a.specs.field_specs.fe51_as_nat, layer_a.specs.field_specs.u64_5_bounded, layer_a.specs.field_specs.fe51_limbs_bounded, layer_a.specs.field_specs_u64.mask51, layer_a.specs.field_specs_u64.spec_reduce, layer_a.backend.serial.u64.field.LOW_51_BIT_MASK, layer_a.backend.serial.u64.field.impl__8.sub_req, layer_a.specs.field_specs.field_sub, layer_a.backend.serial.u64.field.impl__8.obeys_sub_spec, layer_a.specs.field_specs.spec_sub_limbs, layer_a.backend.serial.u64.field.impl__8.sub_spec, layer_a.backend.serial.u64.field.impl__11.mul_req, layer_a.lemmas.field_lemmas.mul_lemmas.mul_term_product_bounds_spec, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_0_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_out_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_return, layer_a.lemmas.field_lemmas.mul_lemmas.mul_boundary_spec, layer_a.specs.field_specs.field_mul, layer_a.backend.serial.u64.field.impl__11.obeys_mul_spec, layer_a.backend.serial.u64.field.impl__11.mul_spec, layer_a.lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive, layer_a.specs.field_specs_u64.sixteen_p_vec, layer_a.specs.field_specs_u64.pre_reduce_limbs, layer_a.specs.field_specs_u64.spec_negate, layer_a.backend.serial.u64.field.impl__13.neg_req, layer_a.specs.field_specs.field_neg, layer_a.backend.serial.u64.field.impl__13.obeys_neg_spec, layer_a.backend.serial.u64.field.impl__13.neg_spec, vstd.slice.len_returns_clause_autospec, layer_a.specs.core_specs.spec_load8_at, layer_a.specs.core_specs.u8_32_as_nat, layer_a.specs.field_specs_u64.compute_q_arr, layer_a.specs.field_specs_u64.compute_unmasked_limbs, layer_a.specs.field_specs_u64.compute_q_spec, layer_a.specs.field_specs_u64.reduce_with_q_spec, layer_a.specs.field_specs_u64.bit_arrange, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing, layer_a.lemmas.field_lemmas.pow2k_lemmas.term_product_bounds_spec, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_0_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.carry_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ai_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_return, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_boundary_spec, vstd.bits.low_bits_mask, layer_a.specs.primality_specs.is_prime, layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_mod_inverse, layer_a.specs.core_specs.word64_from_bytes, layer_a.specs.edwards_specs.edwards_x, layer_a.specs.edwards_specs.edwards_y, layer_a.specs.edwards_specs.edwards_z, layer_a.specs.edwards_specs.edwards_t, layer_a.specs.edwards_specs.edwards_point_limbs_bounded, layer_a.specs.field_specs.spec_fe51_as_bytes, layer_a.core_assumes.seq_from32, layer_a.specs.field_specs.as_bytes_post, layer_a.specs.field_specs.from_bytes_post, layer_a.core_assumes.seq_to_array_32, layer_a.specs.field_specs.field_element_from_bytes, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb2_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb3_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mul_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_div_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_close_mod_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mod_u8_t51_cond, layer_a.specs.field_specs.field_inv, layer_a.specs.field_specs.field_square, layer_a.constants.SQRT_M1, layer_a.specs.field_specs.sqrt_m1, layer_a.specs.field_specs.is_negative, layer_a.specs.field_specs.nat_invsqrt, layer_a.specs.field_specs.field_abs, layer_a.specs.scalar52_specs.group_order]
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_5

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_6 85fa9be89ff75ecf
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_6`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:174:16-174:48`
- Rust/SST construct: Rust source assertion
- AssertId: `6`
- Statement hash: `85fa9be89ff75ecf`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i⟩ ⟨Vermilion.Seq.index bytes i⟩
-/
def assert_6_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "assert"
  statementHash := "85fa9be89ff75ecf"
}
@[vrml_obligation] theorem assert_6
    ...
    (call_lemma_spec_fe51_to_bytes_matches_array_ensures_0 : (∀ (i : Int), (((0 ≤ i) ∧ (i < 32)) → (Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i = Vermilion.Seq.index bytes i))))
    (assert_4 : Vermilion.Seq.len (layer_a.specs.field_specs.spec_fe51_as_bytes fe) = 32)
    (assert_5 : Vermilion.Seq.len (layer_a.core_assumes.seq_from32 bytes) = 32)
    (assume_9 : True)
    (assume_10 : (0 ≤ i) ∧ (i < 32)) :
    Vermilion.Seq.index (layer_a.core_assumes.seq_from32 bytes) i = Vermilion.Seq.index bytes i := by
  iterate 13 (try first | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.factorial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.shifted_binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.product_of_multiples]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u8]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u16]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u32]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u64]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.sum_lemmas.seq_sum]; try norm_num))
  vrml [layer_a.specs.field_specs.sum_of_limbs_bounded, layer_a.backend.serial.u64.field.impl__5.add_req, vstd.arithmetic.power2.pow2, layer_a.specs.field_specs_u64.u64_5_as_nat, layer_a.specs.field_specs.spec_add_fe51_limbs, layer_a.specs.field_specs_u64.p, layer_a.specs.field_specs_u64.field_canonical, layer_a.specs.field_specs_u64.u64_5_as_field_canonical, layer_a.specs.field_specs.fe51_as_canonical_nat, layer_a.specs.field_specs.field_add, layer_a.backend.serial.u64.field.impl__5.obeys_add_spec, layer_a.backend.serial.u64.field.impl__5.add_spec, layer_a.specs.field_specs.fe51_as_nat, layer_a.specs.field_specs.u64_5_bounded, layer_a.specs.field_specs.fe51_limbs_bounded, layer_a.specs.field_specs_u64.mask51, layer_a.specs.field_specs_u64.spec_reduce, layer_a.backend.serial.u64.field.LOW_51_BIT_MASK, layer_a.backend.serial.u64.field.impl__8.sub_req, layer_a.specs.field_specs.field_sub, layer_a.backend.serial.u64.field.impl__8.obeys_sub_spec, layer_a.specs.field_specs.spec_sub_limbs, layer_a.backend.serial.u64.field.impl__8.sub_spec, layer_a.backend.serial.u64.field.impl__11.mul_req, layer_a.lemmas.field_lemmas.mul_lemmas.mul_term_product_bounds_spec, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_0_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_out_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_return, layer_a.lemmas.field_lemmas.mul_lemmas.mul_boundary_spec, layer_a.specs.field_specs.field_mul, layer_a.backend.serial.u64.field.impl__11.obeys_mul_spec, layer_a.backend.serial.u64.field.impl__11.mul_spec, layer_a.lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive, layer_a.specs.field_specs_u64.sixteen_p_vec, layer_a.specs.field_specs_u64.pre_reduce_limbs, layer_a.specs.field_specs_u64.spec_negate, layer_a.backend.serial.u64.field.impl__13.neg_req, layer_a.specs.field_specs.field_neg, layer_a.backend.serial.u64.field.impl__13.obeys_neg_spec, layer_a.backend.serial.u64.field.impl__13.neg_spec, vstd.slice.len_returns_clause_autospec, layer_a.specs.core_specs.spec_load8_at, layer_a.specs.core_specs.u8_32_as_nat, layer_a.specs.field_specs_u64.compute_q_arr, layer_a.specs.field_specs_u64.compute_unmasked_limbs, layer_a.specs.field_specs_u64.compute_q_spec, layer_a.specs.field_specs_u64.reduce_with_q_spec, layer_a.specs.field_specs_u64.bit_arrange, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing, layer_a.lemmas.field_lemmas.pow2k_lemmas.term_product_bounds_spec, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_0_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.carry_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ai_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_return, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_boundary_spec, vstd.bits.low_bits_mask, layer_a.specs.primality_specs.is_prime, layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_mod_inverse, layer_a.specs.core_specs.word64_from_bytes, layer_a.specs.edwards_specs.edwards_x, layer_a.specs.edwards_specs.edwards_y, layer_a.specs.edwards_specs.edwards_z, layer_a.specs.edwards_specs.edwards_t, layer_a.specs.edwards_specs.edwards_point_limbs_bounded, layer_a.specs.field_specs.spec_fe51_as_bytes, layer_a.core_assumes.seq_from32, layer_a.specs.field_specs.as_bytes_post, layer_a.specs.field_specs.from_bytes_post, layer_a.core_assumes.seq_to_array_32, layer_a.specs.field_specs.field_element_from_bytes, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb2_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb3_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mul_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_div_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_close_mod_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mod_u8_t51_cond, layer_a.specs.field_specs.field_inv, layer_a.specs.field_specs.field_square, layer_a.constants.SQRT_M1, layer_a.specs.field_specs.sqrt_m1, layer_a.specs.field_specs.is_negative, layer_a.specs.field_specs.nat_invsqrt, layer_a.specs.field_specs.field_abs, layer_a.specs.scalar52_specs.group_order]
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_6

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_7 2e9cf38b34d34e19
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_7`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:175:16-175:53`
- Rust/SST construct: Rust source assertion
- AssertId: `7`
- Statement hash: `2e9cf38b34d34e19`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i⟩ ⟨Vermilion.Seq.index bytes i⟩
-/
def assert_7_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "assert"
  statementHash := "2e9cf38b34d34e19"
}
@[vrml_obligation] theorem assert_7
    ...
    (assume_9 : True)
    (assume_10 : (0 ≤ i) ∧ (i < 32))
    (assert_6 : Vermilion.Seq.index (layer_a.core_assumes.seq_from32 bytes) i = Vermilion.Seq.index bytes i) :
    Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i = Vermilion.Seq.index bytes i := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_7

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_8 c7092c06a19a7908
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_8`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:173:47-173:96`
- Rust/SST construct: Rust source assertion
- AssertId: `8`
- Statement hash: `c7092c06a19a7908`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i⟩ ⟨Vermilion.Seq.index bytes i⟩
-/
def assert_8_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "assert"
  statementHash := "c7092c06a19a7908"
}
@[vrml_obligation] theorem assert_8
    ...
    (assume_10 : (0 ≤ i) ∧ (i < 32))
    (assert_6 : Vermilion.Seq.index (layer_a.core_assumes.seq_from32 bytes) i = Vermilion.Seq.index bytes i)
    (assert_7 : Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i = Vermilion.Seq.index bytes i) :
    Vermilion.Seq.index (layer_a.core_assumes.seq_from32 bytes) i = Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_8

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_9 d916b1c4a625f85a
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_9`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:178:12-178:56`
- Rust/SST construct: Rust source assertion
- AssertId: `9`
- Statement hash: `d916b1c4a625f85a`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i⟩ ⟨Vermilion.Seq.index bytes i⟩ ⟨Vermilion.Seq.index (layer_a.core_assumes.seq_from32 bytes) i⟩ ⟨Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i⟩
-/
def assert_9_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "assert"
  statementHash := "d916b1c4a625f85a"
}
@[vrml_obligation] theorem assert_9
    ...
    (assert_4 : Vermilion.Seq.len (layer_a.specs.field_specs.spec_fe51_as_bytes fe) = 32)
    (assert_5 : Vermilion.Seq.len (layer_a.core_assumes.seq_from32 bytes) = 32)
    (assume_9 : (∀ (i : Int), (((0 ≤ i) ∧ (i < 32)) → (Vermilion.Seq.index (layer_a.core_assumes.seq_from32 bytes) i = Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i)))) :
    layer_a.core_assumes.seq_from32 bytes = layer_a.specs.field_specs.spec_fe51_as_bytes fe := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.assert_9

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.ensures_10 c710070f26e4dbf9
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.ensures_10`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:157:9-157:52`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `10`
- Statement hash: `c710070f26e4dbf9`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i⟩ ⟨Vermilion.Seq.index bytes i⟩ ⟨Vermilion.Seq.index (layer_a.core_assumes.seq_from32 bytes) i⟩ ⟨Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i⟩
-/
def ensures_10_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes"
  kind := "ensures"
  statementHash := "c710070f26e4dbf9"
}
@[vrml_obligation] theorem ensures_10
    ...
    (assert_5 : Vermilion.Seq.len (layer_a.core_assumes.seq_from32 bytes) = 32)
    (assume_9 : (∀ (i : Int), (((0 ≤ i) ∧ (i < 32)) → (Vermilion.Seq.index (layer_a.core_assumes.seq_from32 bytes) i = Vermilion.Seq.index (layer_a.specs.field_specs.spec_fe51_as_bytes fe) i))))
    (assert_9 : layer_a.core_assumes.seq_from32 bytes = layer_a.specs.field_specs.spec_fe51_as_bytes fe) :
    layer_a.core_assumes.seq_from32 bytes = layer_a.specs.field_specs.spec_fe51_as_bytes fe := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes.ensures_10

end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_equals_spec_fe51_to_bytes
