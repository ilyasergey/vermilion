...
namespace layer_a.specs.proba_specs.axiom_from_bytes_uniform

-- vrml:begin layer_a.specs.proba_specs.axiom_from_bytes_uniform.ensures_0 e68ffbe371b34668
/--
Generated VC `layer_a.specs.proba_specs.axiom_from_bytes_uniform.ensures_0`.

- Rust source: `case-studies/dalek-lite/layer_a.rs:180:17-180:73`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `0`
- Statement hash: `e68ffbe371b34668`
...
def ensures_0_meta : Vermilion.ObligationMeta := {
  rustFile := "case-studies/dalek-lite/layer_a.rs"
  startLine := 180
  startColumn := 17
  endLine := 180
  endColumn := 73
  assertId := "0"
  functionName := "layer_a.specs.proba_specs.axiom_from_bytes_uniform"
  kind := "ensures"
  statementHash := "e68ffbe371b34668"
}
@[vrml_obligation] theorem ensures_0
    ...
    (requires_4 : layer_a.specs.field_specs.fe51_as_nat fe = (Vermilion.emod (layer_a.specs.core_specs.u8_32_as_nat bytes) (vstd.arithmetic.power2.pow2 255)))
    (assume_5 : False) :
    layer_a.specs.proba_specs.is_uniform_bytes bytes → layer_a.specs.proba_specs.is_uniform_field_element fe := by
...
-- vrml:end layer_a.specs.proba_specs.axiom_from_bytes_uniform.ensures_0

end layer_a.specs.proba_specs.axiom_from_bytes_uniform
