...
namespace layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_1 416ac7787c16001b
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:471:12-471:31`
- Rust/SST construct: Rust source assertion
- AssertId: `1`
- Statement hash: `416ac7787c16001b`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index bytes_orig vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes_decoded vrml_i0⟩
-/
def assert_1_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 31
  assertId := "1"
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip"
  kind := "assert"
  statementHash := "416ac7787c16001b"
}
@[vrml_obligation] theorem assert_1
    (bytes_orig : (Vermilion.Seq Int))
    (fe : layer_a.backend.serial.u64.field.FieldElement51)
    (bytes_decoded : (Vermilion.Seq Int))
    (requires_0 : Vermilion.Seq.len bytes_orig = 32)
    (requires_1 : (∀ (vrml_i0 : Int), (((0 ≤ vrml_i0) ∧ (vrml_i0 < Vermilion.Seq.len bytes_orig)) → Vermilion.inUnsignedRange 8 (Vermilion.Seq.index bytes_orig vrml_i0))))
    ...
    (requires_4 : Vermilion.Seq.len bytes_decoded = 32)
    (requires_5 : (∀ (vrml_i0 : Int), (((0 ≤ vrml_i0) ∧ (vrml_i0 < Vermilion.Seq.len bytes_decoded)) → Vermilion.inUnsignedRange 8 (Vermilion.Seq.index bytes_decoded vrml_i0))))
    (requires_6 : layer_a.specs.core_specs.u8_32_as_nat bytes_orig < layer_a.specs.field_specs_u64.p 0)
    (requires_7 : layer_a.specs.field_specs.from_bytes_post bytes_orig fe)
    (requires_8 : layer_a.specs.field_specs.as_bytes_post fe bytes_decoded)
    (assume_9 : True)
  ...
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_1

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_2_0 4899f69356770ceb
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_2_0`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:478:13-478:42`
- Rust/SST construct: call lemma_small_mod
- AssertId: `2_0`
- Statement hash: `4899f69356770ceb`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index bytes_orig vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes_decoded vrml_i0⟩
-/
def call_requires_2_0_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip"
  kind := "call_requires"
  statementHash := "4899f69356770ceb"
}
@[vrml_obligation] theorem call_requires_2_0
    ...
    (assume_10 : True)
    (assume_11 : True) :
    layer_a.specs.core_specs.u8_32_as_nat bytes_orig < vstd.arithmetic.power2.pow2 255 := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_2_0

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_2_1 ddc675360b0ccc19
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_2_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:478:13-478:42`
- Rust/SST construct: call lemma_small_mod
- AssertId: `2_1`
- Statement hash: `ddc675360b0ccc19`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index bytes_orig vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes_decoded vrml_i0⟩
-/
def call_requires_2_1_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip"
  kind := "call_requires"
  statementHash := "ddc675360b0ccc19"
}
@[vrml_obligation] theorem call_requires_2_1
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_2_1

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_3 699e0a1ce585760d
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_3`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:477:16-477:34`
- Rust/SST construct: Rust source assertion
- AssertId: `3`
- Statement hash: `699e0a1ce585760d`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index bytes_orig vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes_decoded vrml_i0⟩
-/
def assert_3_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip"
  kind := "assert"
  statementHash := "699e0a1ce585760d"
}
@[vrml_obligation] theorem assert_3
    ...
    (assume_10 : True)
    (assume_11 : True)
    (call_lemma_small_mod_ensures_0 : (Vermilion.emod (layer_a.specs.core_specs.u8_32_as_nat bytes_orig) (vstd.arithmetic.power2.pow2 255)) = layer_a.specs.core_specs.u8_32_as_nat bytes_orig) :
    (Vermilion.emod (layer_a.specs.core_specs.u8_32_as_nat bytes_orig) (vstd.arithmetic.power2.pow2 255)) = layer_a.specs.core_specs.u8_32_as_nat bytes_orig := by
...
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_3

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_4_0 d739931594321b3f
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_4_0`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:484:13-484:36`
- Rust/SST construct: call lemma_small_mod
- AssertId: `4_0`
- Statement hash: `d739931594321b3f`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index bytes_orig vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes_decoded vrml_i0⟩
-/
def call_requires_4_0_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip"
  kind := "call_requires"
  statementHash := "d739931594321b3f"
}
@[vrml_obligation] theorem call_requires_4_0
    ...
    (assume_9 : True → ((0 < layer_a.specs.field_specs_u64.p 0) ∧ (layer_a.specs.field_specs_u64.p 0 < vstd.arithmetic.power2.pow2 255)))
    (assume_10 : True)
    (assume_11 : True → ((Vermilion.emod (layer_a.specs.core_specs.u8_32_as_nat bytes_orig) (vstd.arithmetic.power2.pow2 255)) = layer_a.specs.core_specs.u8_32_as_nat bytes_orig))
    (assume_12 : True) :
    layer_a.specs.core_specs.u8_32_as_nat bytes_orig < layer_a.specs.field_specs_u64.p 0 := by
  iterate 13 (try first | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.factorial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.shifted_binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.product_of_multiples]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u8]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u16]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u32]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u64]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.sum_lemmas.seq_sum]; try norm_num))
  vrml [layer_a.specs.field_specs.sum_of_limbs_bounded, layer_a.backend.serial.u64.field.impl__5.add_req, vstd.arithmetic.power2.pow2, layer_a.specs.field_specs_u64.u64_5_as_nat, layer_a.specs.field_specs.spec_add_fe51_limbs, layer_a.specs.field_specs_u64.p, layer_a.specs.field_specs_u64.field_canonical, layer_a.specs.field_specs_u64.u64_5_as_field_canonical, layer_a.specs.field_specs.fe51_as_canonical_nat, layer_a.specs.field_specs.field_add, layer_a.backend.serial.u64.field.impl__5.obeys_add_spec, layer_a.backend.serial.u64.field.impl__5.add_spec, layer_a.specs.field_specs.fe51_as_nat, layer_a.specs.field_specs.u64_5_bounded, layer_a.specs.field_specs.fe51_limbs_bounded, layer_a.specs.field_specs_u64.mask51, layer_a.specs.field_specs_u64.spec_reduce, layer_a.backend.serial.u64.field.LOW_51_BIT_MASK, layer_a.backend.serial.u64.field.impl__8.sub_req, layer_a.specs.field_specs.field_sub, layer_a.backend.serial.u64.field.impl__8.obeys_sub_spec, layer_a.specs.field_specs.spec_sub_limbs, layer_a.backend.serial.u64.field.impl__8.sub_spec, layer_a.backend.serial.u64.field.impl__11.mul_req, layer_a.lemmas.field_lemmas.mul_lemmas.mul_term_product_bounds_spec, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_0_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_out_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_return, layer_a.lemmas.field_lemmas.mul_lemmas.mul_boundary_spec, layer_a.specs.field_specs.field_mul, layer_a.backend.serial.u64.field.impl__11.obeys_mul_spec, layer_a.backend.serial.u64.field.impl__11.mul_spec, layer_a.lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive, layer_a.specs.field_specs_u64.sixteen_p_vec, layer_a.specs.field_specs_u64.pre_reduce_limbs, layer_a.specs.field_specs_u64.spec_negate, layer_a.backend.serial.u64.field.impl__13.neg_req, layer_a.specs.field_specs.field_neg, layer_a.backend.serial.u64.field.impl__13.obeys_neg_spec, layer_a.backend.serial.u64.field.impl__13.neg_spec, vstd.slice.len_returns_clause_autospec, layer_a.specs.core_specs.spec_load8_at, layer_a.specs.core_specs.u8_32_as_nat, layer_a.specs.field_specs_u64.compute_q_arr, layer_a.specs.field_specs_u64.compute_unmasked_limbs, layer_a.specs.field_specs_u64.compute_q_spec, layer_a.specs.field_specs_u64.reduce_with_q_spec, layer_a.specs.field_specs_u64.bit_arrange, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing, layer_a.lemmas.field_lemmas.pow2k_lemmas.term_product_bounds_spec, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_0_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.carry_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ai_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_return, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_boundary_spec, vstd.bits.low_bits_mask, layer_a.specs.primality_specs.is_prime, layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_mod_inverse, layer_a.specs.core_specs.word64_from_bytes, layer_a.specs.edwards_specs.edwards_x, layer_a.specs.edwards_specs.edwards_y, layer_a.specs.edwards_specs.edwards_z, layer_a.specs.edwards_specs.edwards_t, layer_a.specs.edwards_specs.edwards_point_limbs_bounded, layer_a.specs.field_specs.spec_fe51_as_bytes, layer_a.core_assumes.seq_from32, layer_a.specs.field_specs.as_bytes_post, layer_a.specs.field_specs.from_bytes_post, layer_a.core_assumes.seq_to_array_32, layer_a.specs.field_specs.field_element_from_bytes, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb2_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb3_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mul_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_div_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_close_mod_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mod_u8_t51_cond, layer_a.specs.field_specs.field_inv, layer_a.specs.field_specs.field_square, layer_a.constants.SQRT_M1, layer_a.specs.field_specs.sqrt_m1, layer_a.specs.field_specs.is_negative, layer_a.specs.field_specs.nat_invsqrt, layer_a.specs.field_specs.field_abs, layer_a.specs.scalar52_specs.group_order]
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_4_0

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_4_1 b8dee380a2fb9799
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_4_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:484:13-484:36`
- Rust/SST construct: call lemma_small_mod
- AssertId: `4_1`
- Statement hash: `b8dee380a2fb9799`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index bytes_orig vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes_decoded vrml_i0⟩
-/
def call_requires_4_1_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip"
  kind := "call_requires"
  statementHash := "b8dee380a2fb9799"
}
@[vrml_obligation] theorem call_requires_4_1
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.call_requires_4_1

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_5 e68c372b2ae778cb
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_5`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:483:16-483:28`
- Rust/SST construct: Rust source assertion
- AssertId: `5`
- Statement hash: `e68c372b2ae778cb`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index bytes_orig vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes_decoded vrml_i0⟩
-/
def assert_5_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip"
  kind := "assert"
  statementHash := "e68c372b2ae778cb"
}
@[vrml_obligation] theorem assert_5
    ...
    (assume_11 : True → ((Vermilion.emod (layer_a.specs.core_specs.u8_32_as_nat bytes_orig) (vstd.arithmetic.power2.pow2 255)) = layer_a.specs.core_specs.u8_32_as_nat bytes_orig))
    (assume_12 : True)
    (call_lemma_small_mod_1_ensures_0 : (Vermilion.emod (layer_a.specs.core_specs.u8_32_as_nat bytes_orig) (layer_a.specs.field_specs_u64.p 0)) = layer_a.specs.core_specs.u8_32_as_nat bytes_orig) :
    (Vermilion.emod (layer_a.specs.core_specs.u8_32_as_nat bytes_orig) (layer_a.specs.field_specs_u64.p 0)) = layer_a.specs.core_specs.u8_32_as_nat bytes_orig := by
  iterate 13 (try first | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.factorial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.shifted_binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.product_of_multiples]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u8]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u16]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u32]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u64]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.sum_lemmas.seq_sum]; try norm_num))
  vrml [layer_a.specs.field_specs.sum_of_limbs_bounded, layer_a.backend.serial.u64.field.impl__5.add_req, vstd.arithmetic.power2.pow2, layer_a.specs.field_specs_u64.u64_5_as_nat, layer_a.specs.field_specs.spec_add_fe51_limbs, layer_a.specs.field_specs_u64.p, layer_a.specs.field_specs_u64.field_canonical, layer_a.specs.field_specs_u64.u64_5_as_field_canonical, layer_a.specs.field_specs.fe51_as_canonical_nat, layer_a.specs.field_specs.field_add, layer_a.backend.serial.u64.field.impl__5.obeys_add_spec, layer_a.backend.serial.u64.field.impl__5.add_spec, layer_a.specs.field_specs.fe51_as_nat, layer_a.specs.field_specs.u64_5_bounded, layer_a.specs.field_specs.fe51_limbs_bounded, layer_a.specs.field_specs_u64.mask51, layer_a.specs.field_specs_u64.spec_reduce, layer_a.backend.serial.u64.field.LOW_51_BIT_MASK, layer_a.backend.serial.u64.field.impl__8.sub_req, layer_a.specs.field_specs.field_sub, layer_a.backend.serial.u64.field.impl__8.obeys_sub_spec, layer_a.specs.field_specs.spec_sub_limbs, layer_a.backend.serial.u64.field.impl__8.sub_spec, layer_a.backend.serial.u64.field.impl__11.mul_req, layer_a.lemmas.field_lemmas.mul_lemmas.mul_term_product_bounds_spec, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_0_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_out_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_return, layer_a.lemmas.field_lemmas.mul_lemmas.mul_boundary_spec, layer_a.specs.field_specs.field_mul, layer_a.backend.serial.u64.field.impl__11.obeys_mul_spec, layer_a.backend.serial.u64.field.impl__11.mul_spec, layer_a.lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive, layer_a.specs.field_specs_u64.sixteen_p_vec, layer_a.specs.field_specs_u64.pre_reduce_limbs, layer_a.specs.field_specs_u64.spec_negate, layer_a.backend.serial.u64.field.impl__13.neg_req, layer_a.specs.field_specs.field_neg, layer_a.backend.serial.u64.field.impl__13.obeys_neg_spec, layer_a.backend.serial.u64.field.impl__13.neg_spec, vstd.slice.len_returns_clause_autospec, layer_a.specs.core_specs.spec_load8_at, layer_a.specs.core_specs.u8_32_as_nat, layer_a.specs.field_specs_u64.compute_q_arr, layer_a.specs.field_specs_u64.compute_unmasked_limbs, layer_a.specs.field_specs_u64.compute_q_spec, layer_a.specs.field_specs_u64.reduce_with_q_spec, layer_a.specs.field_specs_u64.bit_arrange, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing, layer_a.lemmas.field_lemmas.pow2k_lemmas.term_product_bounds_spec, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_0_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.carry_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ai_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_return, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_boundary_spec, vstd.bits.low_bits_mask, layer_a.specs.primality_specs.is_prime, layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_mod_inverse, layer_a.specs.core_specs.word64_from_bytes, layer_a.specs.edwards_specs.edwards_x, layer_a.specs.edwards_specs.edwards_y, layer_a.specs.edwards_specs.edwards_z, layer_a.specs.edwards_specs.edwards_t, layer_a.specs.edwards_specs.edwards_point_limbs_bounded, layer_a.specs.field_specs.spec_fe51_as_bytes, layer_a.core_assumes.seq_from32, layer_a.specs.field_specs.as_bytes_post, layer_a.specs.field_specs.from_bytes_post, layer_a.core_assumes.seq_to_array_32, layer_a.specs.field_specs.field_element_from_bytes, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb2_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb3_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mul_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_div_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_close_mod_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mod_u8_t51_cond, layer_a.specs.field_specs.field_inv, layer_a.specs.field_specs.field_square, layer_a.constants.SQRT_M1, layer_a.specs.field_specs.sqrt_m1, layer_a.specs.field_specs.is_negative, layer_a.specs.field_specs.nat_invsqrt, layer_a.specs.field_specs.field_abs, layer_a.specs.scalar52_specs.group_order]
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_5

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_6 e84004d2d7ebe46c
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_6`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:474:12-474:44`
- Rust/SST construct: Rust source assertion
- AssertId: `6`
- Statement hash: `e84004d2d7ebe46c`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index bytes_orig vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes_decoded vrml_i0⟩
-/
def assert_6_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip"
  kind := "assert"
  statementHash := "e84004d2d7ebe46c"
}
@[vrml_obligation] theorem assert_6
    ...
    (assume_10 : True)
    (assume_11 : True → ((Vermilion.emod (layer_a.specs.core_specs.u8_32_as_nat bytes_orig) (vstd.arithmetic.power2.pow2 255)) = layer_a.specs.core_specs.u8_32_as_nat bytes_orig))
    (assume_12 : True → ((Vermilion.emod (layer_a.specs.core_specs.u8_32_as_nat bytes_orig) (layer_a.specs.field_specs_u64.p 0)) = layer_a.specs.core_specs.u8_32_as_nat bytes_orig)) :
    layer_a.specs.core_specs.u8_32_as_nat bytes_decoded = layer_a.specs.core_specs.u8_32_as_nat bytes_orig := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.assert_6

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.ensures_7 fc3a9265b546cf00
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.ensures_7`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:467:9-467:64`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `7`
- Statement hash: `fc3a9265b546cf00`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index bytes_orig vrml_i0⟩ ⟨Vermilion.Seq.index (layer_a.backend.serial.u64.field.FieldElement51.get_FieldElement51_limbs fe) vrml_i0⟩ ⟨Vermilion.Seq.index bytes_decoded vrml_i0⟩
-/
def ensures_7_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip"
  kind := "ensures"
  statementHash := "fc3a9265b546cf00"
}
@[vrml_obligation] theorem ensures_7
    ...
    (requires_8 : layer_a.specs.field_specs.as_bytes_post fe bytes_decoded)
    (assume_9 : True → ((0 < layer_a.specs.field_specs_u64.p 0) ∧ (layer_a.specs.field_specs_u64.p 0 < vstd.arithmetic.power2.pow2 255)))
    (assume_10 : True → (layer_a.specs.core_specs.u8_32_as_nat bytes_decoded = layer_a.specs.core_specs.u8_32_as_nat bytes_orig)) :
    layer_a.specs.core_specs.u8_32_as_nat bytes_decoded = layer_a.specs.core_specs.u8_32_as_nat bytes_orig := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip.ensures_7

end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_as_bytes_from_bytes_roundtrip
