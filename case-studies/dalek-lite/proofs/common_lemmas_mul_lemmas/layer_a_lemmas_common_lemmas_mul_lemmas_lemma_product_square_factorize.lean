...
namespace layer_a.lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize

-- vrml:begin layer_a.lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize.ensures_6 db9736435aaaf262
/--
Generated VC `layer_a.lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize.ensures_6`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:250:9-250:47`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `6`
- Statement hash: `db9736435aaaf262`
-/
def ensures_6_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 47
  assertId := "6"
  functionName := "layer_a.lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize"
  kind := "ensures"
  statementHash := "db9736435aaaf262"
}
@[vrml_obligation] theorem ensures_6
    (a : Int)
    (b : Int)
    (call_lemma_mul_is_associative_ensures_0 : (a * (b * (a * b))) = ((a * b) * (a * b)))
    (call_lemma_mul_is_associative_1_ensures_0 : (b * (a * b)) = ((b * a) * b))
    (call_lemma_mul_is_commutative_ensures_0 : (b * a) = (a * b))
    (call_lemma_mul_is_associative_2_ensures_0 : (a * ((a * b) * b)) = ((a * (a * b)) * b))
    (call_lemma_mul_is_associative_3_ensures_0 : (a * (a * b)) = ((a * a) * b))
    (call_lemma_mul_is_associative_4_ensures_0 : ((a * a) * (b * b)) = (((a * a) * b) * b)) :
    ((a * b) * (a * b)) = ((a * a) * (b * b)) := by
...
-- vrml:end layer_a.lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize.ensures_6

end layer_a.lemmas.common_lemmas.mul_lemmas.lemma_product_square_factorize
