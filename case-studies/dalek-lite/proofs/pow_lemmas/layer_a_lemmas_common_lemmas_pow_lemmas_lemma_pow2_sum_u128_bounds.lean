...
namespace layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_1 f550d1d2a3793d8b
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `1`
- Statement hash: `f550d1d2a3793d8b`
...
def assert_1_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 72
  assertId := "1"
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "f550d1d2a3793d8b"
}
@[vrml_obligation] theorem assert_1
    ...
    (step : Int)
    (k : Int)
    (requires_0 : (∀ (vrml_i0 : Int), (((0 ≤ vrml_i0) ∧ (vrml_i0 < Vermilion.Seq.len coefs)) → Vermilion.inUnsignedRange 128 (Vermilion.Seq.index coefs vrml_i0))))
    (requires_1 : 0 ≤ offset)
    (requires_2 : 0 ≤ step)
    (requires_3 : 0 ≤ k)
...
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_1

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_3 3c85825a11af566b
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_3`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `3`
- Statement hash: `3c85825a11af566b`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_3_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "3c85825a11af566b"
}
@[vrml_obligation] theorem assert_3
  ...
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_3

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_4 cbfdfb79327c4909
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_4`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `4`
- Statement hash: `cbfdfb79327c4909`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_4_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "cbfdfb79327c4909"
}
@[vrml_obligation] theorem assert_4
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_4

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_5 6b60cc459b3f61f0
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_5`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `5`
- Statement hash: `6b60cc459b3f61f0`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_5_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "6b60cc459b3f61f0"
}
@[vrml_obligation] theorem assert_5
    ...
    (assume_10 : True) :
    layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step 0 = Vermilion.natClip (Vermilion.Seq.index coefs offset * vstd.arithmetic.power2.pow2 0) := by
  iterate 13 (try first | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.factorial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.shifted_binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.product_of_multiples]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u8]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u16]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u32]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u64]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.sum_lemmas.seq_sum]; try norm_num))
  vrml [layer_a.specs.field_specs.sum_of_limbs_bounded, layer_a.backend.serial.u64.field.impl__5.add_req, vstd.arithmetic.power2.pow2, layer_a.specs.field_specs_u64.u64_5_as_nat, layer_a.specs.field_specs.spec_add_fe51_limbs, layer_a.specs.field_specs_u64.p, layer_a.specs.field_specs_u64.field_canonical, layer_a.specs.field_specs_u64.u64_5_as_field_canonical, layer_a.specs.field_specs.fe51_as_canonical_nat, layer_a.specs.field_specs.field_add, layer_a.backend.serial.u64.field.impl__5.obeys_add_spec, layer_a.backend.serial.u64.field.impl__5.add_spec, layer_a.specs.field_specs.fe51_as_nat, layer_a.specs.field_specs.u64_5_bounded, layer_a.specs.field_specs.fe51_limbs_bounded, layer_a.specs.field_specs_u64.mask51, layer_a.specs.field_specs_u64.spec_reduce, layer_a.backend.serial.u64.field.LOW_51_BIT_MASK, layer_a.backend.serial.u64.field.impl__8.sub_req, layer_a.specs.field_specs.field_sub, layer_a.backend.serial.u64.field.impl__8.obeys_sub_spec, layer_a.specs.field_specs.spec_sub_limbs, layer_a.backend.serial.u64.field.impl__8.sub_spec, layer_a.backend.serial.u64.field.impl__11.mul_req, layer_a.lemmas.field_lemmas.mul_lemmas.mul_term_product_bounds_spec, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_0_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_out_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_return, layer_a.lemmas.field_lemmas.mul_lemmas.mul_boundary_spec, layer_a.specs.field_specs.field_mul, layer_a.backend.serial.u64.field.impl__11.obeys_mul_spec, layer_a.backend.serial.u64.field.impl__11.mul_spec, layer_a.lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive, layer_a.specs.field_specs_u64.sixteen_p_vec, layer_a.specs.field_specs_u64.pre_reduce_limbs, layer_a.specs.field_specs_u64.spec_negate, layer_a.backend.serial.u64.field.impl__13.neg_req, layer_a.specs.field_specs.field_neg, layer_a.backend.serial.u64.field.impl__13.obeys_neg_spec, layer_a.backend.serial.u64.field.impl__13.neg_spec, vstd.slice.len_returns_clause_autospec, layer_a.specs.core_specs.spec_load8_at, layer_a.specs.core_specs.u8_32_as_nat, layer_a.specs.field_specs_u64.compute_q_arr, layer_a.specs.field_specs_u64.compute_unmasked_limbs, layer_a.specs.field_specs_u64.compute_q_spec, layer_a.specs.field_specs_u64.reduce_with_q_spec, layer_a.specs.field_specs_u64.bit_arrange, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing, layer_a.lemmas.field_lemmas.pow2k_lemmas.term_product_bounds_spec, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_0_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.carry_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ai_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_return, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_boundary_spec, vstd.bits.low_bits_mask, layer_a.specs.primality_specs.is_prime, layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_mod_inverse, layer_a.specs.core_specs.word64_from_bytes, layer_a.specs.edwards_specs.edwards_x, layer_a.specs.edwards_specs.edwards_y, layer_a.specs.edwards_specs.edwards_z, layer_a.specs.edwards_specs.edwards_t, layer_a.specs.edwards_specs.edwards_point_limbs_bounded, layer_a.specs.field_specs.spec_fe51_as_bytes, layer_a.core_assumes.seq_from32, layer_a.specs.field_specs.as_bytes_post, layer_a.specs.field_specs.from_bytes_post, layer_a.core_assumes.seq_to_array_32, layer_a.specs.field_specs.field_element_from_bytes, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb2_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb3_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mul_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_div_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_close_mod_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mod_u8_t51_cond, layer_a.specs.field_specs.field_inv, layer_a.specs.field_specs.field_square, layer_a.constants.SQRT_M1, layer_a.specs.field_specs.sqrt_m1, layer_a.specs.field_specs.is_negative, layer_a.specs.field_specs.nat_invsqrt, layer_a.specs.field_specs.field_abs, layer_a.specs.scalar52_specs.group_order]
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_5

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_7 5414cffdc1a1188f
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_7`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `7`
- Statement hash: `5414cffdc1a1188f`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_7_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "5414cffdc1a1188f"
}
@[vrml_obligation] theorem assert_7
    ...
    (assume_8 : True → ((Vermilion.Seq.index coefs offset * vstd.arithmetic.power2.pow2 0) = Vermilion.Seq.index coefs offset))
    (assert_4 : Vermilion.Seq.index coefs (Vermilion.natClip (offset + 0)) < vstd.arithmetic.power2.pow2 step)
    (assume_10 : True → (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step 0 = Vermilion.natClip (Vermilion.Seq.index coefs offset * vstd.arithmetic.power2.pow2 0)))
    (assume_11 : True)
    (call_lemma_mul_basics_3_1_ensures_0 : (step * 1) = step) :
    Vermilion.natClip (1 * step) = step := by
  iterate 13 (try first | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.factorial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.shifted_binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.product_of_multiples]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u8]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u16]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u32]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u64]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.sum_lemmas.seq_sum]; try norm_num))
  vrml [layer_a.specs.field_specs.sum_of_limbs_bounded, layer_a.backend.serial.u64.field.impl__5.add_req, vstd.arithmetic.power2.pow2, layer_a.specs.field_specs_u64.u64_5_as_nat, layer_a.specs.field_specs.spec_add_fe51_limbs, layer_a.specs.field_specs_u64.p, layer_a.specs.field_specs_u64.field_canonical, layer_a.specs.field_specs_u64.u64_5_as_field_canonical, layer_a.specs.field_specs.fe51_as_canonical_nat, layer_a.specs.field_specs.field_add, layer_a.backend.serial.u64.field.impl__5.obeys_add_spec, layer_a.backend.serial.u64.field.impl__5.add_spec, layer_a.specs.field_specs.fe51_as_nat, layer_a.specs.field_specs.u64_5_bounded, layer_a.specs.field_specs.fe51_limbs_bounded, layer_a.specs.field_specs_u64.mask51, layer_a.specs.field_specs_u64.spec_reduce, layer_a.backend.serial.u64.field.LOW_51_BIT_MASK, layer_a.backend.serial.u64.field.impl__8.sub_req, layer_a.specs.field_specs.field_sub, layer_a.backend.serial.u64.field.impl__8.obeys_sub_spec, layer_a.specs.field_specs.spec_sub_limbs, layer_a.backend.serial.u64.field.impl__8.sub_spec, layer_a.backend.serial.u64.field.impl__11.mul_req, layer_a.lemmas.field_lemmas.mul_lemmas.mul_term_product_bounds_spec, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_0_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_out_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_return, layer_a.lemmas.field_lemmas.mul_lemmas.mul_boundary_spec, layer_a.specs.field_specs.field_mul, layer_a.backend.serial.u64.field.impl__11.obeys_mul_spec, layer_a.backend.serial.u64.field.impl__11.mul_spec, layer_a.lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive, layer_a.specs.field_specs_u64.sixteen_p_vec, layer_a.specs.field_specs_u64.pre_reduce_limbs, layer_a.specs.field_specs_u64.spec_negate, layer_a.backend.serial.u64.field.impl__13.neg_req, layer_a.specs.field_specs.field_neg, layer_a.backend.serial.u64.field.impl__13.obeys_neg_spec, layer_a.backend.serial.u64.field.impl__13.neg_spec, vstd.slice.len_returns_clause_autospec, layer_a.specs.core_specs.spec_load8_at, layer_a.specs.core_specs.u8_32_as_nat, layer_a.specs.field_specs_u64.compute_q_arr, layer_a.specs.field_specs_u64.compute_unmasked_limbs, layer_a.specs.field_specs_u64.compute_q_spec, layer_a.specs.field_specs_u64.reduce_with_q_spec, layer_a.specs.field_specs_u64.bit_arrange, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing, layer_a.lemmas.field_lemmas.pow2k_lemmas.term_product_bounds_spec, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_0_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.carry_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ai_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_return, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_boundary_spec, vstd.bits.low_bits_mask, layer_a.specs.primality_specs.is_prime, layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_mod_inverse, layer_a.specs.core_specs.word64_from_bytes, layer_a.specs.edwards_specs.edwards_x, layer_a.specs.edwards_specs.edwards_y, layer_a.specs.edwards_specs.edwards_z, layer_a.specs.edwards_specs.edwards_t, layer_a.specs.edwards_specs.edwards_point_limbs_bounded, layer_a.specs.field_specs.spec_fe51_as_bytes, layer_a.core_assumes.seq_from32, layer_a.specs.field_specs.as_bytes_post, layer_a.specs.field_specs.from_bytes_post, layer_a.core_assumes.seq_to_array_32, layer_a.specs.field_specs.field_element_from_bytes, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb2_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb3_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mul_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_div_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_close_mod_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mod_u8_t51_cond, layer_a.specs.field_specs.field_inv, layer_a.specs.field_specs.field_square, layer_a.constants.SQRT_M1, layer_a.specs.field_specs.sqrt_m1, layer_a.specs.field_specs.is_negative, layer_a.specs.field_specs.nat_invsqrt, layer_a.specs.field_specs.field_abs, layer_a.specs.scalar52_specs.group_order]
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_7

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_8 c28476c6c417b308
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_8`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `8`
- Statement hash: `c28476c6c417b308`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_8_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "c28476c6c417b308"
}
@[vrml_obligation] theorem assert_8
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_8

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_9 69e909d4633f0656
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_9`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `9`
- Statement hash: `69e909d4633f0656`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_9_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "69e909d4633f0656"
}
@[vrml_obligation] theorem assert_9
    ...
    layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step k < vstd.arithmetic.power2.pow2 (Vermilion.natClip (Vermilion.natClip (k + 1) * step)) := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_9

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_10 8cbafa3341f7efbb
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_10`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `10`
- Statement hash: `8cbafa3341f7efbb`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_10_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "8cbafa3341f7efbb"
}
@[vrml_obligation] theorem assert_10
    ...
    (branch_0 : (¬ (k = 0)))
    (assume_7 : True) :
    layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step k = (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step (Vermilion.natClip (k - 1)) + (Vermilion.Seq.index coefs (Vermilion.natClip (offset + k)) * vstd.arithmetic.power2.pow2 (Vermilion.natClip (k * step)))) := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_10

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_anonymous_0 2b07de451c6e8e00
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_anonymous_0`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: could not prove termination
- AssertId: `anonymous_0`
- Statement hash: `2b07de451c6e8e00`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_anonymous_0_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "2b07de451c6e8e00"
}
@[vrml_obligation] theorem assert_anonymous_0
    ...
    (requires_5 : (∀ (i : Int), ((0 ≤ i) → (((0 ≤ i) ∧ (i ≤ k)) → (Vermilion.Seq.index coefs (Vermilion.natClip (offset + i)) < vstd.arithmetic.power2.pow2 step)))))
    (branch_0 : (¬ (k = 0)))
    (assume_7 : True → (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step k = (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step (Vermilion.natClip (k - 1)) + (Vermilion.Seq.index coefs (Vermilion.natClip (offset + k)) * vstd.arithmetic.power2.pow2 (Vermilion.natClip (k * step))))))
    (assume_8 : True) :
    ((0 ≤ Vermilion.natClip (k - 1)) ∧ (Vermilion.natClip (k - 1) < k)) ∨ ((Vermilion.natClip (k - 1) = k) ∧ False) := by
  iterate 13 (try first | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.factorial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.shifted_binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.product_of_multiples]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u8]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u16]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u32]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u64]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.sum_lemmas.seq_sum]; try norm_num))
  vrml [layer_a.specs.field_specs.sum_of_limbs_bounded, layer_a.backend.serial.u64.field.impl__5.add_req, vstd.arithmetic.power2.pow2, layer_a.specs.field_specs_u64.u64_5_as_nat, layer_a.specs.field_specs.spec_add_fe51_limbs, layer_a.specs.field_specs_u64.p, layer_a.specs.field_specs_u64.field_canonical, layer_a.specs.field_specs_u64.u64_5_as_field_canonical, layer_a.specs.field_specs.fe51_as_canonical_nat, layer_a.specs.field_specs.field_add, layer_a.backend.serial.u64.field.impl__5.obeys_add_spec, layer_a.backend.serial.u64.field.impl__5.add_spec, layer_a.specs.field_specs.fe51_as_nat, layer_a.specs.field_specs.u64_5_bounded, layer_a.specs.field_specs.fe51_limbs_bounded, layer_a.specs.field_specs_u64.mask51, layer_a.specs.field_specs_u64.spec_reduce, layer_a.backend.serial.u64.field.LOW_51_BIT_MASK, layer_a.backend.serial.u64.field.impl__8.sub_req, layer_a.specs.field_specs.field_sub, layer_a.backend.serial.u64.field.impl__8.obeys_sub_spec, layer_a.specs.field_specs.spec_sub_limbs, layer_a.backend.serial.u64.field.impl__8.sub_spec, layer_a.backend.serial.u64.field.impl__11.mul_req, layer_a.lemmas.field_lemmas.mul_lemmas.mul_term_product_bounds_spec, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_0_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_out_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_return, layer_a.lemmas.field_lemmas.mul_lemmas.mul_boundary_spec, layer_a.specs.field_specs.field_mul, layer_a.backend.serial.u64.field.impl__11.obeys_mul_spec, layer_a.backend.serial.u64.field.impl__11.mul_spec, layer_a.lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive, layer_a.specs.field_specs_u64.sixteen_p_vec, layer_a.specs.field_specs_u64.pre_reduce_limbs, layer_a.specs.field_specs_u64.spec_negate, layer_a.backend.serial.u64.field.impl__13.neg_req, layer_a.specs.field_specs.field_neg, layer_a.backend.serial.u64.field.impl__13.obeys_neg_spec, layer_a.backend.serial.u64.field.impl__13.neg_spec, vstd.slice.len_returns_clause_autospec, layer_a.specs.core_specs.spec_load8_at, layer_a.specs.core_specs.u8_32_as_nat, layer_a.specs.field_specs_u64.compute_q_arr, layer_a.specs.field_specs_u64.compute_unmasked_limbs, layer_a.specs.field_specs_u64.compute_q_spec, layer_a.specs.field_specs_u64.reduce_with_q_spec, layer_a.specs.field_specs_u64.bit_arrange, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing, layer_a.lemmas.field_lemmas.pow2k_lemmas.term_product_bounds_spec, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_0_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.carry_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ai_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_return, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_boundary_spec, vstd.bits.low_bits_mask, layer_a.specs.primality_specs.is_prime, layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_mod_inverse, layer_a.specs.core_specs.word64_from_bytes, layer_a.specs.edwards_specs.edwards_x, layer_a.specs.edwards_specs.edwards_y, layer_a.specs.edwards_specs.edwards_z, layer_a.specs.edwards_specs.edwards_t, layer_a.specs.edwards_specs.edwards_point_limbs_bounded, layer_a.specs.field_specs.spec_fe51_as_bytes, layer_a.core_assumes.seq_from32, layer_a.specs.field_specs.as_bytes_post, layer_a.specs.field_specs.from_bytes_post, layer_a.core_assumes.seq_to_array_32, layer_a.specs.field_specs.field_element_from_bytes, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb2_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb3_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mul_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_div_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_close_mod_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mod_u8_t51_cond, layer_a.specs.field_specs.field_inv, layer_a.specs.field_specs.field_square, layer_a.constants.SQRT_M1, layer_a.specs.field_specs.sqrt_m1, layer_a.specs.field_specs.is_negative, layer_a.specs.field_specs.nat_invsqrt, layer_a.specs.field_specs.field_abs, layer_a.specs.scalar52_specs.group_order]
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_anonymous_0

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.call_requires_11_0 5f9b39741e730e5b
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.call_requires_11_0`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: call lemma_pow2_sum_u128_bounds
- AssertId: `11_0`
- Statement hash: `5f9b39741e730e5b`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def call_requires_11_0_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "call_requires"
  statementHash := "5f9b39741e730e5b"
}
@[vrml_obligation] theorem call_requires_11_0
  ...
  iterate 13 (try first | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_extended_gcd]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.factorial]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.shifted_binomial_sum]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.number_theory_lemmas.product_of_multiples]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u8]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u16]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u32]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u64]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128]; try norm_num) | (rw [layer_a.lemmas.common_lemmas.sum_lemmas.seq_sum]; try norm_num))
  vrml [layer_a.specs.field_specs.sum_of_limbs_bounded, layer_a.backend.serial.u64.field.impl__5.add_req, vstd.arithmetic.power2.pow2, layer_a.specs.field_specs_u64.u64_5_as_nat, layer_a.specs.field_specs.spec_add_fe51_limbs, layer_a.specs.field_specs_u64.p, layer_a.specs.field_specs_u64.field_canonical, layer_a.specs.field_specs_u64.u64_5_as_field_canonical, layer_a.specs.field_specs.fe51_as_canonical_nat, layer_a.specs.field_specs.field_add, layer_a.backend.serial.u64.field.impl__5.obeys_add_spec, layer_a.backend.serial.u64.field.impl__5.add_spec, layer_a.specs.field_specs.fe51_as_nat, layer_a.specs.field_specs.u64_5_bounded, layer_a.specs.field_specs.fe51_limbs_bounded, layer_a.specs.field_specs_u64.mask51, layer_a.specs.field_specs_u64.spec_reduce, layer_a.backend.serial.u64.field.LOW_51_BIT_MASK, layer_a.backend.serial.u64.field.impl__8.sub_req, layer_a.specs.field_specs.field_sub, layer_a.backend.serial.u64.field.impl__8.obeys_sub_spec, layer_a.specs.field_specs.spec_sub_limbs, layer_a.backend.serial.u64.field.impl__8.sub_spec, layer_a.backend.serial.u64.field.impl__11.mul_req, layer_a.lemmas.field_lemmas.mul_lemmas.mul_term_product_bounds_spec, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_0_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c0_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c1_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c2_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c3_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_c4_val, layer_a.lemmas.field_lemmas.mul_lemmas.mul_ci_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_out_val_boundaries, layer_a.lemmas.field_lemmas.mul_lemmas.mul_return, layer_a.lemmas.field_lemmas.mul_lemmas.mul_boundary_spec, layer_a.specs.field_specs.field_mul, layer_a.backend.serial.u64.field.impl__11.obeys_mul_spec, layer_a.backend.serial.u64.field.impl__11.mul_spec, layer_a.lemmas.field_lemmas.negate_lemmas.all_neg_limbs_positive, layer_a.specs.field_specs_u64.sixteen_p_vec, layer_a.specs.field_specs_u64.pre_reduce_limbs, layer_a.specs.field_specs_u64.spec_negate, layer_a.backend.serial.u64.field.impl__13.neg_req, layer_a.specs.field_specs.field_neg, layer_a.backend.serial.u64.field.impl__13.obeys_neg_spec, layer_a.backend.serial.u64.field.impl__13.neg_spec, vstd.slice.len_returns_clause_autospec, layer_a.specs.core_specs.spec_load8_at, layer_a.specs.core_specs.u8_32_as_nat, layer_a.specs.field_specs_u64.compute_q_arr, layer_a.specs.field_specs_u64.compute_unmasked_limbs, layer_a.specs.field_specs_u64.compute_q_spec, layer_a.specs.field_specs_u64.reduce_with_q_spec, layer_a.specs.field_specs_u64.bit_arrange, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.bytes_match_limbs_packing, layer_a.lemmas.field_lemmas.pow2k_lemmas.term_product_bounds_spec, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_0_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.c0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c3_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.c4_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ci_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a2_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a3_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a4_0_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.carry_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.a0_2_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.ai_val_boundaries, layer_a.lemmas.field_lemmas.pow2k_lemmas.a1_1_val, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_return, layer_a.lemmas.field_lemmas.pow2k_lemmas.pow2k_loop_boundary_spec, vstd.bits.low_bits_mask, layer_a.specs.primality_specs.is_prime, layer_a.lemmas.common_lemmas.number_theory_lemmas.spec_mod_inverse, layer_a.specs.core_specs.word64_from_bytes, layer_a.specs.edwards_specs.edwards_x, layer_a.specs.edwards_specs.edwards_y, layer_a.specs.edwards_specs.edwards_z, layer_a.specs.edwards_specs.edwards_t, layer_a.specs.edwards_specs.edwards_point_limbs_bounded, layer_a.specs.field_specs.spec_fe51_as_bytes, layer_a.core_assumes.seq_from32, layer_a.specs.field_specs.as_bytes_post, layer_a.specs.field_specs.from_bytes_post, layer_a.core_assumes.seq_to_array_32, layer_a.specs.field_specs.field_element_from_bytes, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb0_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb1_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb2_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb3_byte_contribution, layer_a.lemmas.field_lemmas.limbs_to_bytes_lemmas.limb4_byte_contribution, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mul_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_div_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_close_mod_u8_t51_cond, layer_a.lemmas.field_lemmas.load8_lemmas.pow2_mul_div_mod_small_mod_u8_t51_cond, layer_a.specs.field_specs.field_inv, layer_a.specs.field_specs.field_square, layer_a.constants.SQRT_M1, layer_a.specs.field_specs.sqrt_m1, layer_a.specs.field_specs.is_negative, layer_a.specs.field_specs.nat_invsqrt, layer_a.specs.field_specs.field_abs, layer_a.specs.scalar52_specs.group_order]
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.call_requires_11_0

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.call_requires_11_1 22fce46640e4abff
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.call_requires_11_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: call lemma_pow2_sum_u128_bounds
- AssertId: `11_1`
- Statement hash: `22fce46640e4abff`
...
def call_requires_11_1_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "call_requires"
  statementHash := "22fce46640e4abff"
}
@[vrml_obligation] theorem call_requires_11_1
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.call_requires_11_1

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_12 4c6797b576991d27
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_12`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `12`
- Statement hash: `4c6797b576991d27`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_12_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "4c6797b576991d27"
}
@[vrml_obligation] theorem assert_12
    ...
    (assume_8 : True)
    (assert_anonymous_0 : ((0 ≤ Vermilion.natClip (k - 1)) ∧ (Vermilion.natClip (k - 1) < k)) ∨ ((Vermilion.natClip (k - 1) = k) ∧ False))
    (call_lemma_pow2_sum_u128_bounds_ensures_0 : layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step (Vermilion.natClip (k - 1)) < vstd.arithmetic.power2.pow2 (Vermilion.natClip (Vermilion.natClip (Vermilion.natClip (k - 1) + 1) * step))) :
    layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step (Vermilion.natClip (k - 1)) < vstd.arithmetic.power2.pow2 (Vermilion.natClip (k * step)) := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_12

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_14 0f176238656de835
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_14`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `14`
- Statement hash: `0f176238656de835`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_14_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "0f176238656de835"
}
@[vrml_obligation] theorem assert_14
    ...
    (branch_0 : (¬ (k = 0)))
    (assume_7 : True → (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step k = (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step (Vermilion.natClip (k - 1)) + (Vermilion.Seq.index coefs (Vermilion.natClip (offset + k)) * vstd.arithmetic.power2.pow2 (Vermilion.natClip (k * step))))))
    (assume_8 : True → (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step (Vermilion.natClip (k - 1)) < vstd.arithmetic.power2.pow2 (Vermilion.natClip (k * step))))
    (assume_9 : True)
    (assume_10 : True)
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_14

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.call_requires_15 2c6ee74eca8127a0
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.call_requires_15`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: call lemma_pow2_mul_bound_general
- AssertId: `15`
- Statement hash: `2c6ee74eca8127a0`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def call_requires_15_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "call_requires"
  statementHash := "2c6ee74eca8127a0"
}
@[vrml_obligation] theorem call_requires_15
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.call_requires_15

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_16 a0bf63f4d233df94
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_16`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `16`
- Statement hash: `a0bf63f4d233df94`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_16_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "a0bf63f4d233df94"
}
@[vrml_obligation] theorem assert_16
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_16

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_17 1d74b44cc780ca9d
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_17`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `17`
- Statement hash: `1d74b44cc780ca9d`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_17_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "1d74b44cc780ca9d"
}
@[vrml_obligation] theorem assert_17
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_17

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_18 6f184d04ec36d941
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_18`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: Rust source assertion
- AssertId: `18`
- Statement hash: `6f184d04ec36d941`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def assert_18_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "assert"
  statementHash := "6f184d04ec36d941"
}
@[vrml_obligation] theorem assert_18
  ...
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.assert_18

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.ensures_19 0565f0f7dff10126
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.ensures_19`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:1019:1-1019:72`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `19`
- Statement hash: `0565f0f7dff10126`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index coefs vrml_i0⟩ ⟨Vermilion.Seq.index coefs (Vermilion.natClip (offset + i))⟩
-/
def ensures_19_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds"
  kind := "ensures"
  statementHash := "0565f0f7dff10126"
}
@[vrml_obligation] theorem ensures_19
    ...
    (then_0_assume_10 : (k = 0) → (True → (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step 0 = Vermilion.natClip (Vermilion.Seq.index coefs offset * vstd.arithmetic.power2.pow2 0))))
    ...
    (then_0_assert_9 : (k = 0) → (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step k < vstd.arithmetic.power2.pow2 (Vermilion.natClip (Vermilion.natClip (k + 1) * step))))
    (else_0_assume_7 : (¬ (k = 0)) → (True → (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step k = (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step (Vermilion.natClip (k - 1)) + (Vermilion.Seq.index coefs (Vermilion.natClip (offset + k)) * vstd.arithmetic.power2.pow2 (Vermilion.natClip (k * step)))))))
    (else_0_assume_8 : (¬ (k = 0)) → (True → (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step (Vermilion.natClip (k - 1)) < vstd.arithmetic.power2.pow2 (Vermilion.natClip (k * step)))))
    ...
    (else_0_assert_18 : (¬ (k = 0)) → (layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step k < vstd.arithmetic.power2.pow2 (Vermilion.natClip (Vermilion.natClip (k + 1) * step)))) :
    layer_a.lemmas.common_lemmas.pow_lemmas.pow2_sum_u128 coefs offset step k < vstd.arithmetic.power2.pow2 (Vermilion.natClip (Vermilion.natClip (k + 1) * step)) := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds.ensures_19

end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_sum_u128_bounds
