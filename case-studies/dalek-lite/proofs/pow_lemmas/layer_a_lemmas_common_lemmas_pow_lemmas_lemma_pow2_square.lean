...
namespace layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square.call_requires_1 63feafc7a071909c
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square.call_requires_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:142:5-142:29`
- Rust/SST construct: call lemma_pow2_unfold
- AssertId: `1`
- Statement hash: `63feafc7a071909c`
-/
def call_requires_1_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 29
  assertId := "1"
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square"
  kind := "call_requires"
  statementHash := "63feafc7a071909c"
}
@[vrml_obligation] theorem call_requires_1
    (v : Int)
    (i : Int)
    (requires_0 : 0 ≤ i)
    (call_lemma_pow_adds_ensures_0 : vstd.arithmetic.power.pow v (Vermilion.natClip (vstd.arithmetic.power2.pow2 i + vstd.arithmetic.power2.pow2 i)) = (vstd.arithmetic.power.pow v (vstd.arithmetic.power2.pow2 i) * vstd.arithmetic.power.pow v (vstd.arithmetic.power2.pow2 i))) :
    Vermilion.natClip (i + 1) > 0 := by
...
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square.call_requires_1

-- vrml:begin layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square.ensures_2 dfe044df66d8f480
/--
Generated VC `layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square.ensures_2`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/pow_lemmas.rs:137:9-137:65`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `2`
- Statement hash: `dfe044df66d8f480`
-/
def ensures_2_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square"
  kind := "ensures"
  statementHash := "dfe044df66d8f480"
}
@[vrml_obligation] theorem ensures_2
    ...
    (requires_0 : 0 ≤ i)
    (call_lemma_pow_adds_ensures_0 : vstd.arithmetic.power.pow v (Vermilion.natClip (vstd.arithmetic.power2.pow2 i + vstd.arithmetic.power2.pow2 i)) = (vstd.arithmetic.power.pow v (vstd.arithmetic.power2.pow2 i) * vstd.arithmetic.power.pow v (vstd.arithmetic.power2.pow2 i)))
    (call_lemma_pow2_unfold_ensures_0 : vstd.arithmetic.power2.pow2 (Vermilion.natClip (i + 1)) = Vermilion.natClip (2 * vstd.arithmetic.power2.pow2 (Vermilion.natClip (Vermilion.natClip (i + 1) - 1)))) :
    (vstd.arithmetic.power.pow v (vstd.arithmetic.power2.pow2 i) * vstd.arithmetic.power.pow v (vstd.arithmetic.power2.pow2 i)) = vstd.arithmetic.power.pow v (vstd.arithmetic.power2.pow2 (Vermilion.natClip (i + 1))) := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square.ensures_2

end layer_a.lemmas.common_lemmas.pow_lemmas.lemma_pow2_square
