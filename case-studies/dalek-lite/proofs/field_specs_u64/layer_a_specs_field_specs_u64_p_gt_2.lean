...
namespace layer_a.specs.field_specs_u64.p_gt_2

-- vrml:begin layer_a.specs.field_specs_u64.p_gt_2.call_requires_1 d90379061bda34fb
/--
Generated VC `layer_a.specs.field_specs_u64.p_gt_2.call_requires_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/specs/field_specs_u64.rs:41:5-41:42`
- Rust/SST construct: call lemma_pow2_strictly_increases
- AssertId: `1`
- Statement hash: `d90379061bda34fb`
-/
def call_requires_1_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 42
  assertId := "1"
  functionName := "layer_a.specs.field_specs_u64.p_gt_2"
  kind := "call_requires"
  statementHash := "d90379061bda34fb"
}
...
-- vrml:end layer_a.specs.field_specs_u64.p_gt_2.call_requires_1

-- vrml:begin layer_a.specs.field_specs_u64.p_gt_2.ensures_2_0 f5f95a558c1f3fd4
/--
Generated VC `layer_a.specs.field_specs_u64.p_gt_2.ensures_2_0`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/specs/field_specs_u64.rs:37:9-37:16`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `2_0`
- Statement hash: `f5f95a558c1f3fd4`
-/
def ensures_2_0_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.specs.field_specs_u64.p_gt_2"
  kind := "ensures"
  statementHash := "f5f95a558c1f3fd4"
}
@[vrml_obligation] theorem ensures_2_0
    ...
    (call_lemma2_to64_ensures_32 : vstd.arithmetic.power2.pow2 32 = 4294967296)
    (call_lemma2_to64_ensures_33 : vstd.arithmetic.power2.pow2 64 = 18446744073709551616)
    (call_lemma_pow2_strictly_increases_ensures_0 : vstd.arithmetic.power2.pow2 5 < vstd.arithmetic.power2.pow2 255) :
    layer_a.specs.field_specs_u64.p 0 > 2 := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.specs.field_specs_u64.p_gt_2.ensures_2_0

-- vrml:begin layer_a.specs.field_specs_u64.p_gt_2.ensures_2_1 11e5a52c592f3422
/--
Generated VC `layer_a.specs.field_specs_u64.p_gt_2.ensures_2_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/specs/field_specs_u64.rs:38:9-38:22`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `2_1`
- Statement hash: `11e5a52c592f3422`
-/
def ensures_2_1_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.specs.field_specs_u64.p_gt_2"
  kind := "ensures"
  statementHash := "11e5a52c592f3422"
}
@[vrml_obligation] theorem ensures_2_1
    ...
    (call_lemma2_to64_ensures_33 : vstd.arithmetic.power2.pow2 64 = 18446744073709551616)
    (call_lemma_pow2_strictly_increases_ensures_0 : vstd.arithmetic.power2.pow2 5 < vstd.arithmetic.power2.pow2 255) :
    (layer_a.specs.field_specs_u64.p 0 - 2) > 0 := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.specs.field_specs_u64.p_gt_2.ensures_2_1

end layer_a.specs.field_specs_u64.p_gt_2
