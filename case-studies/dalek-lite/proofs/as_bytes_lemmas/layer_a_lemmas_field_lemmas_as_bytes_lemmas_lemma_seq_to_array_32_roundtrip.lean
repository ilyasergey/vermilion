...
namespace layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip.assert_0 2fbf19240f9b419f
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip.assert_0`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:828:12-828:34`
- Rust/SST construct: Rust source assertion
- AssertId: `0`
- Statement hash: `2fbf19240f9b419f`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index s vrml_i0⟩
-/
def assert_0_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 34
  assertId := "0"
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip"
  kind := "assert"
  statementHash := "2fbf19240f9b419f"
}
@[vrml_obligation] theorem assert_0
    (s : (Vermilion.Seq Int))
    (requires_0 : (∀ (vrml_i0 : Int), (((0 ≤ vrml_i0) ∧ (vrml_i0 < Vermilion.Seq.len s)) → Vermilion.inUnsignedRange 8 (Vermilion.Seq.index s vrml_i0))))
    (requires_1 : Vermilion.Seq.len s = 32) :
    s = layer_a.core_assumes.seq_from32 (layer_a.core_assumes.seq_to_array_32 s) := by
  -- TODO(vermilion): automation failed; prove this obligation.
  sorry
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip.assert_0

-- vrml:begin layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip.ensures_1 1c059f891b0b5a01
/--
Generated VC `layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip.ensures_1`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/field_lemmas/as_bytes_lemmas.rs:822:9-822:45`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `1`
- Statement hash: `1c059f891b0b5a01`
- Triggers (Verus, for future e-matching): ⟨Vermilion.Seq.index s vrml_i0⟩
-/
def ensures_1_meta : Vermilion.ObligationMeta := {
  ...
  functionName := "layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip"
  kind := "ensures"
  statementHash := "1c059f891b0b5a01"
}
@[vrml_obligation] theorem ensures_1
    (s : (Vermilion.Seq Int))
    (requires_0 : (∀ (vrml_i0 : Int), (((0 ≤ vrml_i0) ∧ (vrml_i0 < Vermilion.Seq.len s)) → Vermilion.inUnsignedRange 8 (Vermilion.Seq.index s vrml_i0))))
    (requires_1 : Vermilion.Seq.len s = 32)
    (assert_0 : s = layer_a.core_assumes.seq_from32 (layer_a.core_assumes.seq_to_array_32 s)) :
    s = layer_a.core_assumes.seq_from32 (layer_a.core_assumes.seq_to_array_32 s) := by
...
-- vrml:end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip.ensures_1

end layer_a.lemmas.field_lemmas.as_bytes_lemmas.lemma_seq_to_array_32_roundtrip
