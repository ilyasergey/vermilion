...
namespace layer_a.lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod

-- vrml:begin layer_a.lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod.ensures_3 56506df49424fd5f
/--
Generated VC `layer_a.lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod.ensures_3`.

- Rust source: `case-studies/dalek-lite/upstream/curve25519-dalek/src/lemmas/common_lemmas/mul_lemmas.rs:201:9-201:55`
- Rust/SST construct: function postcondition (`ensures`)
- AssertId: `3`
- Statement hash: `56506df49424fd5f`
-/
def ensures_3_meta : Vermilion.ObligationMeta := {
  ...
  endColumn := 55
  assertId := "3"
  functionName := "layer_a.lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod"
  kind := "ensures"
  statementHash := "56506df49424fd5f"
}
@[vrml_obligation] theorem ensures_3
    ...
    (a2 : Int)
    (b2 : Int)
    (call_lemma_mul_is_associative_ensures_0 : ((a1 * b1) * (a2 * b2)) = (((a1 * b1) * a2) * b2))
    (call_lemma_mul_is_associative_1_ensures_0 : (a2 * (a1 * b1)) = ((a2 * a1) * b1))
    (call_lemma_mul_is_associative_2_ensures_0 : ((a2 * a1) * (b1 * b2)) = (((a2 * a1) * b1) * b2)) :
...
-- vrml:end layer_a.lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod.ensures_3

end layer_a.lemmas.common_lemmas.mul_lemmas.lemma_mul_quad_prod
